...
const incidents_gateway_1 = require("./incidents.gateway");
...
exports.IncidentsModule = IncidentsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([incidents_entity_1.Incident]),
            auth_module_1.AuthModule
        ],
        controllers: [incidents_controller_1.IncidentsController],
        providers: [incidents_service_1.IncidentsService, incidents_gateway_1.IncidentsGateway],
